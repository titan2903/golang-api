...
func FormatUserTransactions(transactions []Transaction) []UserTransactionFormatter {
	...
	for _, transaction := range transactions {
		formatter := FormatUserTransaction(transaction) //! sebuah object dari FormatUserTransaction
		transactionFormatter = append(transactionFormatter, formatter) //! dimasukkan ke slice of UserTransactionFormatter
	}
